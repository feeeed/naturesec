<template>
    ...
    >
        ...
        <v-row>
            ...
            <div class="mylogo">
                <v-img
                :src="require('../../assets/WDOMcutdq1U.webp')"
                width="200"
                >
                </v-img>
            </div>
            <div class="companyTitle">
                ...
                >
                    ...
                    <p class="text-body-1 font-italic mb-16">
                        Мы постоянно развиваемся, расширяем объёмы задач.
                         И сегодня мы готовы к долгосрочному взаимовыгодному сотрудничеству
                          со всеми предпринимателями.
                    </p>
                </v-sheet>
            </div>
            </v-col>
        ...
        <v-row>
            <v-col
            class="mt-10 d-flex align-center"
            cols="12"
            sm="6"
            >
                <p class="text-body-1 font-weight-bold">
                    © {{ new Date().getFullYear() }} Природоохранный центр
                    </p>
            </v-col>
            <v-col
