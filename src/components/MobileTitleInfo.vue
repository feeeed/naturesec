<template>
  <v-row>
      ...
      >
        ...
        <v-card-item>
          <div class="text-medium-emphasis">
            Значительный опыт в области создания проектов.
          </div>
        </v-card-item>
      </v-card>
    </v-col>
    <v-col cols="6">
      ...
      >
        <v-card-item>
          <div class="font-weight-medium">Наш рейтинг среди клиентов</div>
        </v-card-item>
        <v-card-item>
          <v-rating
            v-model="rating"
    ...
    <v-col cols="8">
      ...
      >
        <v-card-item>
          ...
          <v-icon icon="mdi-card-bulleted-settings" size="45" class="my-5">
          </v-icon>
          <div class="my-3 font-weight-medium text-medium-emphasis">
