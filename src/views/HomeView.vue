    ...
    <v-main class="bg-grey-lighten-3">
      <v-dialog v-model="dialog2" width="auto">
        <v-card>
          ...
          <v-card-actions>
            <v-btn color="green" block @click="dialog2 = false">Закрыть</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
      <v-container>
        ...
        <v-row justify="center">
          <v-col cols="12" lg="3" xl="2" class="pt-7">
            <div class="stickyMenu">
              ...
              <v-sheet elevation="1" :rounded="true">
                ...
                <div class="px-4 pt-4 text-center text-h6">Группировка</div>
                <div class="pa-4">
                  <my-select
              ...
              <v-card v-if="dialog2 === false" class="my-4" :rounded="true">
                <v-card-text>
                  <span class="text-red text-center">Внимание!</span>
                  <br />
                  Срок сдачи отчётности за 2023 год!
          ...
          <v-col cols="12" lg="6" xl="6" sm="12" class="justify-center">
            <post-list :posts="selectedPostsAndSearch" v-if="!isPostsLoading" />
            <div v-else>
              Идёт загрузка...
              <v-progress-linear
                indeterminate
